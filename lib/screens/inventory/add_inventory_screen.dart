...
class _AddInventoryScreenState extends State<AddInventoryScreen> {
      ...
      setState(() {
        ...
        if (selectedSupplierName != null &&
            !fetchedSuppliers.any(
              (s) => s.supplierName == selectedSupplierName,
            )) {
  ...
  Future<void> _submitInventory() async {
    ...
    final String priceText = productPrice.text.trim();
    final String quantityText = productQuantity.text.trim();
    ...
    Suppliermodel? selectedSupplierDetails;
    if (selectedSupplierName != null) {
      try {
        selectedSupplierDetails = supplier.firstWhere(
          (s) => s.supplierName == selectedSupplierName,
        );
      } catch (_) {
    ...
    try {
      await appRepository.createInventory(draft);
      if (!mounted) return;
